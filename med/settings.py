...
SECRET_KEY = 'django-insecure-rih5=)i$^3(r58ea&8fcghsf2#0fw$yg=#6v7jr2nczd@w+1pt'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'django.template.context_processors.request',  # Needed for admin sidebar
                ...
                'medapp.context_processors.navbar_categories',
            ],
        },
    },
]
...
ASGI_APPLICATION = 'med.asgi.application'
